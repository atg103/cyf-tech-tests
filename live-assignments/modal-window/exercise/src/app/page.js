...
export default function Home() {
  return (
    <div className={styles.container}>
      ...
      <MyModal>
        Vivamus sollicitudin pulvinar egestas. Duis faucibus enim libero, pulvinar rutrum turpis varius at. Mauris aliquet nunc urna, consectetur semper elit molestie efficitur. Sed cursus vitae turpis ac mollis. Nunc sit amet tortor ut orci ullamcorper tristique.
      </MyModal>
